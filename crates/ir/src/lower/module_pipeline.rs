...
use krypton_typechecker::typed_ast::{
    self, ExportedTypeKind, OverloadSignature, QualifiedName, ResolvedBindingRef,
    ResolvedCallableRef, ResolvedConstructorRef, ResolvedTraitMethodRef, ResolvedVariantRef,
    TypedExpr, TypedExprKind, TypedModule,
};
use krypton_typechecker::types::{SchemeVarId, Type, TypeScheme, TypeVarGen, TypeVarId};
...
use crate::{
    CanonicalRef, Expr, ExprKind, ExternCallKind, ExternFnDef, ExternTarget, ExternTraitBridge,
    ExternTraitDef, ExternTraitMethodDef, ExternTypeDef, FnDef, FnId, FnIdentity, ImportedFnDef,
    InstanceDef, Literal, LocalSymbolKey, Module, ModulePath, PrimOp, SimpleExpr, SimpleExprKind,
    StructDef, SumTypeDef, TraitDef, TraitMethodDef, VariantDef,
};
...
pub(super) fn collect_tuple_arities_from_fn(func: &FnDef, arities: &mut std::collections::BTreeSet<usize>) {
...
pub(super) fn collect_tuple_arities_from_type(ty: &IrType, arities: &mut std::collections::BTreeSet<usize>) {
    match ty {
        IrType::Tuple(elems) => {
...
pub(super) fn collect_tuple_arities_from_expr(expr: &Expr, arities: &mut std::collections::BTreeSet<usize>) {
