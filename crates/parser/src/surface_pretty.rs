...
pub struct SurfacePrettyConfig {
    pub indent_width: usize,
}

impl Default for SurfacePrettyConfig {
    fn default() -> Self {
        Self { indent_width: 4 }
    }
}

pub fn surface_pretty_print(module: &Module) -> String {
    surface_pretty_print_with(module, &SurfacePrettyConfig::default())
}

pub fn surface_pretty_print_with(module: &Module, config: &SurfacePrettyConfig) -> String {
    let mut f = Formatter {
        config,
        indent_level: 0,
        buf: String::new(),
