...
pub fn surface_parse(source: &str) -> (Module, Vec<ParseError>) {
    let (tokens, lex_errors) = surface_lexer::surface_lexer().parse(source).into_output_errors();
